...
import { handleDelete } from '@/lib/handle-delete';
    ...
    <div className="flex items-center justify-between mb-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          {description && <p className="text-[#ababab]">{description}</p>}
        </div>
      </div>
          ...
          <Button
            ...
            onClick={() =>
              handleDelete({
                ...
                onSuccess: () =>
                  deleteOptions.redirectPath
                    ? router.push(deleteOptions.redirectPath)
                    : router.back(),
              })
            }
          >
