...
export function LocationModal({
  ...
  const initialValues = {
    ...
    latitude:
      existingLocationData?.latitude !== undefined
        ? existingLocationData.latitude.toString()
        : '',
    longitude:
      existingLocationData?.longitude !== undefined
        ? existingLocationData.longitude.toString()
        : '',
  };
  ...
  const handleSubmit = async (values: typeof initialValues, helpers: any) => {
    try {
      ...
      helpers.resetForm();
      onLocationCreated(locationData, result.uuid || result.id);
      onClose();
    } catch (error: any) {
  ...
  return (
    <Modal open={open} onClose={onClose} size="xlg-center" title="Location">
