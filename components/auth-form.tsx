    ...
    <div className="min-h-screen bg-[#f8f8f8] flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <div className="w-12 h-12 bg-[#ff6600] rounded-lg flex items-center justify-center mx-auto mb-4">
            <span className="text-white font-bold text-xl">B</span>
          </div>
          <CardTitle className="text-2xl text-[#444444]">
            Business Manager
          </CardTitle>
          ...
          <Tabs defaultValue="login" className="w-full">
            ...
            <TabsContent value="login" className="space-y-4">
              <form onSubmit={handleSubmit(true)} className="space-y-4">
                ...
                <Button
                  type="submit"
                  className="w-full bg-[#ff6600] hover:bg-[#ff6b00]"
                >
                  Sign In
                </Button>
