...
import { createEntityContext } from './context-factory';
...
export function createEntityLayout<T>({
  ...
  if (!finalUseGetQuery || !finalEntityName) {
    throw new Error(
      'Either provide storeName or both entityName and useGetQuery'
    );
  }
  ...
  function EntityLayoutContent({
    children,
    useEntityContext,
  }: {
    children: React.ReactNode;
    useEntityContext: () => any;
  }) {
